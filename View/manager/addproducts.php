    ...
    <div class="container add-product">
        ...
        <form action="#" method="post" class="form-product">
            ...
            <div class="title-product">
                <label for="title">
                    <p>Tên sản phẩm:</p>
                    <input type="text" name="title" placeholder="Nhập tên sản phẩm" id="title" required>
                </label>
            </div>
            <div class="regular_price-product">
                <label for="regular_price">
                    <p>Giá gốc:</p>
                    <input type="number" name="regular_price" placeholder="Nhập giá gốc" id="regular_price" required>
                </label>
            </div>
            <div class="sale_price-product">
                <label for="sale_price">
                    <p>Giá khuyến mãi:</p>
                    <input type="number" name="sale_price" placeholder="Nhập giá khuyến mãi" id="sale_price">
                </label>
            </div>
            <div class="image-product">
                <label for="image">
                    <p>Ảnh:</p>
                    <input type="text" name="image" placeholder="Nhập link ảnh" id="image" required>
                </label>
            </div>
            <div class="descrip-product">
                <label for="descrip">
                    <p>Mô tả:</p>
                    <textarea name="descrip" id="descrip" cols="43" rows="3"></textarea>
                </label>                
            </div>
            <div class="cate">
                <label for="cate">
            ...
            <input type="submit" name="add_product" value="OK">
        </form>
    </div>
</body>
</html>