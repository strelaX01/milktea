...
<body>
    ...
    <div class="container add-categories">
        <h3>Sửa danh mục</h3>
        <div class="action">
            <a href="?action=manager&categories_manager">Quay lại</a>
        </div>
        <?php 
        if(isset($categoryID)){
            ?>
            <form action="#" class="form-cate" method="post">
                <label for="name">
                    Tên danh mục:
                    <input type="text" name="name" value="<?php echo $categoryID['title'] ?>" placeholder="Nhập tên danh mục" id="name" required>
                </label>
                <label for="image">
                    Ảnh:
                    <input type="text" name="image" value="<?php echo $categoryID['img'] ?>" placeholder="Nhập link ảnh" id="image" required>
                </label>
                <input type="submit" name="update_category" value="OK">
            </form>         
            <?php
        }
        ?>
