...
<body>
    ...
    <div class="container add-categories">
        ...
        <form action="#" method="post" class="form-cate">
            <label for="name">
                Tên danh mục:
                <input type="text" name="name" placeholder="Nhập tên danh mục" id="name" required>
            </label>
            <label for="image">
                Ảnh:
                <input type="text" name="image" placeholder="Nhập link ảnh" id="image" required>
            </label>
            <input type="submit" name="add_category" value="OK">
        </form>
    </div>
</body>
</html>