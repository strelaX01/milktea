...
<body>
    ...
    <div class="container account">
        ...
        <div class="action">
            <a class="home" href="http://localhost/milktea">Trang chủ</a>
            <a class="change" href="?action=changepass">Đổi mật khẩu</a>
        ...
        <table>
            ...
            <tbody>
                <?php 
                $i = 0;
                foreach ($billUser as $key => $value) {
                    $i++;
                    $data_order = json_decode($value['data_order']);
                    ?>
                        <tr>
                            <td><?php echo $i; ?></td>
                            ...
                            <td>
                                <table>
                                    <?php
                                    foreach ($data_order->title as $key => $title) {
                                        ?>
                                        <tr>
                            ...
                            <td>
                                <table>
                                    <?php
                                    foreach ($data_order->quantity as $key => $quantity) {
                                        ?>
                                        <tr>
                            ...
                            <td>
                                <table>
                                    <?php
                                    foreach ($data_order->summ as $key => $summ) {
                                        ?>
                                        <tr>
                                            <td class="sum"><?php echo $summ; ?></td>
                                        </tr>
                                        <?php
                                    }
                                    ?> 
        ...
        <?php
            ...
            ?>
            <div class="message">
                <p>Bạn chưa đặt đơn nào!!<a href="http://localhost/milktea"> Đặt hàng ngay </a></p>
            </div>
            <?php
        }
        ?>
